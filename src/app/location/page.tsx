...
import { MapPin, Phone, Clock, Star, Heart, Navigation, Users } from "lucide-react";
  ...
  const locations = [
    {
      ...
      description: "The best karaoke experience in the city with private rooms and premium sound systems."
    },
    {
      id: "2",
      ...
      description: "Fun atmosphere with themed rooms and special events every weekend."
    },
    {
      id: "3",
      ...
      description: "Premium karaoke with high-quality microphones and sound engineering."
    },
    {
      id: "4",
      ...
      description: "Professional-grade karaoke experience with recording options."
    },
    {
      id: "5",
      name: "Melody Palace",
      ...
      description: "Family-friendly karaoke with special deals during weekdays."
    },
    {
      id: "6",
      ...
      description: "Great selection of songs in multiple languages with private and group rooms."
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-1 gap-6">
          {locations.map((location) => (
            <div key={location.id} className="bg-gray-800/30 backdrop-blur-sm rounded-lg overflow-hidden hover:bg-gray-700/30 transition-all">
                ...
                <div className="p-6 flex-1">
                  <div className="flex justify-between items-start">
                    ...
                    <div className="flex items-center space-x-1 bg-gray-700 px-2 py-1 rounded">
                      ...
                      <span className="text-gray-400 ml-1">({location.reviews})</span>
                    </div>
                  </div>
