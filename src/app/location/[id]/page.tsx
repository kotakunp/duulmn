    ...
    switch (id) {
      case "karaoke-central":
        return {
          ...
          description: "The best karaoke experience in the city with private rooms and premium sound systems. Our state-of-the-art equipment ensures crystal-clear audio and the largest song selection in town.",
          website: "https://karaokcentral.com",
          features: ["Private Rooms", "Premium Sound", "Food & Drinks", "VIP Packages"],
          upcomingEvents: [
            { id: "1", name: "Open Mic Night", date: "2023-10-15", time: "8:00 PM" },
            { id: "2", name: "80s Theme Night", date: "2023-10-20", time: "9:00 PM" },
            { id: "3", name: "Karaoke Tournament", date: "2023-10-25", time: "7:00 PM" }
          ],
          photos: [
      ...
      case "sing-dance-lounge":
        return {
          ...
          description: "Fun atmosphere with themed rooms and special events every weekend. Perfect for groups and parties. Dance floors and professional lighting create an amazing experience.",
          website: "https://singdancelounge.com",
          features: ["Dance Floors", "Themed Rooms", "Group Packages", "Professional Lighting"],
          upcomingEvents: [
            { id: "1", name: "Weekend Party", date: "2023-10-14", time: "9:00 PM" },
            { id: "2", name: "Couple's Night", date: "2023-10-17", time: "7:00 PM" },
            { id: "3", name: "Family Day", date: "2023-10-22", time: "2:00 PM" }
          ],
          photos: [
      ...
      case "echo-karaoke":
        return {
          ...
          description: "Premium karaoke with high-quality microphones and sound engineering. Our professional-grade equipment provides the perfect sound for your performance.",
          website: "https://echokaraoke.com",
          features: ["Professional Mics", "Sound Engineering", "Recording", "VIP Treatment"],
          upcomingEvents: [
            { id: "1", name: "Singing Competition", date: "2023-10-16", time: "8:00 PM" },
            { id: "2", name: "Music Night", date: "2023-10-19", time: "7:00 PM" },
            { id: "3", name: "Artist Showcase", date: "2023-10-26", time: "9:00 PM" }
          ],
          photos: [
          ...
          <div className="w-full md:w-1/3">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center space-x-1 bg-gray-800 w-fit px-3 py-1 rounded">
                ...
                <span className="text-gray-400 text-sm ml-1">({location.reviews} reviews)</span>
              </div>
